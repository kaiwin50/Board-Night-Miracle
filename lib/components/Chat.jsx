...
export default () => {
    ...
    return (
        <>
            <Button position={"fixed"} bottom={"16rem"} left={"0"} onClick={onToggle} w={100} bg="red">Chat</Button>
            <Slide direction='bottom' in={isOpen} style={{ zIndex: 10, maxWidth: "fit-content" }}>
